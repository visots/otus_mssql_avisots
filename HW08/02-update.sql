SELECT PhoneNumber, FaxNumber, FullName
from  Application.People
WHERE PersonId = 3;


update Application.People SET PhoneNumber = '(495) 555-1111',FaxNumber = '(495) 555-3333'
WHERE PersonId = 3;

update Application.People SET PhoneNumber = '(415) 555-0102', FaxNumber = '(415) 555-0103'
OUTPUT inserted.PhoneNumber as new_phon, inserted.FaxNumber as new_fax
	, deleted.PhoneNumber as old_phon, deleted.FaxNumber old_fax
WHERE PersonId = 3;
...
UPDATE Application.People SET FirstSale = (	SELECT MIN(InvoiceDate)
...
UPDATE P SET FirstSale2 = I.MinInvoiceDate
...
--
UPDATE Application.People SET FirstSale = NULL, FirstSale2 = NULL
...
FROM Application.People AS P
JOIN (SELECT SalespersonPersonID, Count(InvoiceId) AS SalesCount
	FROM Sales.Invoices
	WHERE InvoiceDate < '20140101'
	GROUP BY SalespersonPersonID
	) AS I ON P.PersonID = I.SalespersonPersonID;

UPDATE P SET TotalSaleCount = TotalSaleCount + I.SalesCount
FROM Application.People AS P
JOIN (
...
UPDATE P SET TotalSaleCount += I.SalesCount 
...
--
UPDATE Application.People SET TotalSaleCount = 0;
...
UPDATE Cust SET CustomerCategoryName = sourceCustomerCategoryName;
